...
// thêm taikhoan và thongtintaikhoan
...
const DatPhongSchema = new mongoose.Schema(
    {
        MaDatPhong: { type: String, unique: true },
...
const HoaDonSchema = new mongoose.Schema({
    MaHoaDon: { type: String, unique: true },
    DatPhongId: { type: mongoose.Types.ObjectId, required: true, ref: 'datphongs' },
...
const TaiKhoanSchema = new mongoose.Schema({
    ...
    Role: { type: Number, default: 0 }, // 0: khach hang, 1: nhan vien, 2: quan ly
})

const ThongTinTaiKhoanSchema = new mongoose.Schema({
    TaiKhoanId: {type: mongoose.Schema.Types.ObjectId, required: true, ref: 'taikhoans'},
    HoTen: { type: String },
    SDT: { type: String },
    Email: {type: String },
    LinkAvatar: { type: String },
...
const Data_TaiKhoan_Model = mongoose.model('taikhoans', TaiKhoanSchema)
const Data_ThongTinTaiKhoan_Model = mongoose.model('thongtintaikhoans', ThongTinTaiKhoanSchema)
